...
admin.site.register(SelectedSports)
...
class StakesAdmin(admin.ModelAdmin):
    ...
    list_display = ('id','round_bal','percent_1','percent_2',
                    'percent_3','percent_4','percent_5',
                    'percent_6','percent_7','percent_8',
                    'percent_9','percent_10')
...
class BetTriggersAdmin(admin.ModelAdmin):
    ...
    list_display = ('id','b1_trig','b2_trig','l1_trig', 'l2_trig', 'armbot'
                    )
