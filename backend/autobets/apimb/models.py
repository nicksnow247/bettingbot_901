...
class SelectedSports(models.Model):
    sport_id = models.BigIntegerField(null=False)
    sport_name = models.CharField(null=True, max_length=100)
...
class UserStakes(models.Model):
    back_stake = models.FloatField(null=True, blank=True)
    lay_stake = models.FloatField(null=True, blank=True)    
...
class BetTriggers(models.Model):
    ...
    tigger_mode = models.IntegerField(null=True)
    armbot = models.BooleanField()
...
class Runner(models.Model):
    ...
    bettriggers = models.ForeignKey(BetTriggers, null=True, default=None, on_delete=models.CASCADE) # ! new ! this is for bet trigger
    stakes = models.ForeignKey(Stakes, null=True, default=None, on_delete=models.CASCADE)           # ! new ! this is for bet auto stakes
    userstakes = models.ForeignKey(UserStakes, null=True, default=None, on_delete=models.CASCADE)   # ! new ! this is for bet user stakes
    order = models.ForeignKey(Orders, null=True, default=None, on_delete=models.CASCADE)   # ! new ! this is for bet user stakes
